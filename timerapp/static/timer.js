...
function roshanTime() {
    ...
    rules.rules.push({"time": rosh_kill_time+1, "message": "Roshan has been Killed!"});
    rules.rules.push({"time": rosh_kill_time+1, "message": "Aegis will be claimed at: " + formatTime(aegis_claim)});
    rules.rules.push({"time": rosh_kill_time+1, "message": "Roshan will respawn between " + formatTime(rosh_respawn_init) + " and " + formatTime(rosh_respawn_end)});
